...
import { getBrands, saveCar } from "@/hooks/Api";
...
export default function Register() {
  ...
  const onSubmit = async (data) => {
    ...
    // TODO LLAMAR AL METODO QUE REGISTRA
    ...
    <>
      {marcas && (
        <div className="container col-4 mt-5 p-3 border border-1 rounded d-flex flex-column">
          <h2 className="mt-1 d-flex justify-content-center">Nuevo carro</h2>
              ...
              <select {...register("marca")} id="brand" className="form-select">
                {marcas.map((marca) => (
                  <option
                    ...
                    selected={marca.external_id === marcas[0].external_id}
                  >
                    {marca.nombre}
                  </option>
                ))}
